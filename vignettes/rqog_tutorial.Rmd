...
1. Total social expenditure (public) `socx_expsocpu`
2. Income inequality: Gini coefficient; level; late 2000s `socx_ginilvl`
3. Gross national income per capita `socx_gnic`
4. General government debt `socx_govdept`
...
# Subset the data
dat2 <- dat[c("cname","year","socx_expsocpu",
                            "socx_ginilvl",
                            "socx_gnic",
                            "socx_govdebt")]
# melt to long format
