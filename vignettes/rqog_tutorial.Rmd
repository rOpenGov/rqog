...
-  [QoG Social Policy Data](http://www.qog.pol.gu.se/data/datadownloads/qogsocialpolicydata/)
...
1. [Basic data codebook](http://www.qogdata.pol.gu.se/data/qog_bas_jan15.pdf)
2. [Standard data codebook](http://www.qogdata.pol.gu.se/data/qog_std_jan15.pdf)
3. [OECD data codebook](http://www.qogdata.pol.gu.se/data/qog_oecd_jan15.pdf)

Discontinued datasets

- [Social Policy data codebook](http://www.qogdata.pol.gu.se/codebook/codebook_social_4apr12.pdf)
...
Basic data has a limited selection of most common indicators incluiding totally 143 variables. Below is an example on how to extract data on human development index and Democracy (Freedom House/Polity) index from BRIC-countries from 1990 to 2010 and plot


```{rExampleBasic, cache=FALSE, message=FALSE,warning=FALSE, eval=FALSE, fig.width=12}
library(rqog)
...
dat2 <- dat2[c("cname","year","fh_polity2","wdi_gdpgr")]
...
```{rExampleStandard, cache=FALSE, message=FALSE,warning=FALSE, eval=FALSE, fig.width=12}
library(rqog)
# Download a local coppy of the file
...
```{rExampleSocialPolicy, cache=FALSE, message=FALSE,warning=FALSE, eval=FALSE, fig.width=12}
library(rqog)
# Download a local coppy of the file
dat <- read_qog("oecd", "cross-sectional")
# Subset the data
...
```{rExampleQogSpatial, cache=FALSE, message=FALSE,warning=FALSE, eval=FALSE, fig.width=12}
library(rqog)
dat <- read_qog("standard", "cross-sectional")
# Subset the data
dat2 <- dat[c("cname","epi_epi")]
# melt to long format
library(reshape2)
dat.l <- melt(dat2, id.vars=c("cname"))
dat.l <- dat.l[!is.na(dat.l$value), ]
