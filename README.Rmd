...
```{rExampleBasic, cache=TRUE, message=FALSE,warning=FALSE, eval=FALSE}
library(rQog)
...
```{rExampleStandard, cache=TRUE, message=FALSE,warning=FALSE, eval=FALSE}
library(rQog)
...
```{rExampleQogSpatial, cache=TRUE, message=FALSE,warning=FALSE, eval=FALSE}
